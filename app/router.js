 ...
 * @Last Modified time: yyyy-10-Th 02:07:31
 * @Func: 应用的路由配置部分
 */
module.exports = app => {
     ...
     * 学生分数
     */
    router.get('/exam_student/getscore',controller.exam.exam.score)
    /**
     * 根据班级接口获取班级学生分数
     */
    router.post('/grade/getstudent',controller.exam.exam.getscores)
}